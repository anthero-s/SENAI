...
function criarCard(prato) {
 ...
 <!-- text-gray-500 text-sm = Bootstrap: card-text text-muted -->  <p class="text-gray-500 text-sm mb-3">${prato.categoria}</p> 
 <!-- text-green-600 font-bold = Bootstrap: text-success fw-bold -->  <p class="text-green-600 font-bold text-lg mb-4"> 
 ${prato.formatarPreco()} 
 </p> 
 <!-- mt-auto = empurra o botão pro fundo = Bootstrap: card-footer -->  <button class="mt-auto w-full bg-red-700 text-white 
